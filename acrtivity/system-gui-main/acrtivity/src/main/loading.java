...
public loading(String destination) { 
        ...
        initComponents();
        setLocationRelativeTo(null); // Center the loading screen
        
        // Save the destination so the Timer can see it later
        ...
        javax.swing.Timer timer = new javax.swing.Timer(50, new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(java.awt.event.ActionEvent e) {
                ...
                int currentVal = jProgressBar1.getValue(); // Ensure your bar is named jProgressBar1
                ...
                if (currentVal < 100) {
                    ...
                    if (target.equalsIgnoreCase("admin")) {
                        // Make sure you have a file named AdminDashboard.java
                        // If not, use: new dashboard().setVisible(true);
                         new AdminDashboard().setVisible(true); 
                    } 
                    // 2. CHECK FOR USER
                    else if (target.equalsIgnoreCase("user")) {
                        // Go to the standard User Dashboard
                        new dashboard().setVisible(true);
                    }
                    // 3. CHECK FOR LOGIN REQUEST (e.g. Log Out)
                    else if (target.equalsIgnoreCase("login")) {
                        panel login = new panel(); 
                        login.setVisible(true);
                    }
                    // 4. DEFAULT (Go to Landing Page)
                    else {
